...
const Profile = () => {
  ...
  const handleUserInfoUpdate = () => {
    // Assuming the updated information is sent to the server or saved in localStorage
    const updatedUser = {
      firstName,
      lastName,
      email,
    ...
    // Example of storing updated info in localStorage (this can be an API call)
        ...
        <div className="profile-right">
          ...
          {activeTab === "userInfo" && (
            <div className="user-info">
              ...
              <button className="update-button" onClick={handleUserInfoUpdate}>Update</button>
            </div>
          )}
